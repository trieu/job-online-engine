...
/**
 * Simple library for Google Blogger API
 */
class gdata_blogger_service extends gdata_ci_loader {

    public static function getInstance($params = array()) {
        $instance = new gdata_blogger_service($params);
        return $instance;
    }
    ...
    public function __construct($params = array()) {
        ...
        if(count($params) == 2){
            ...
            return $this->connectToService($email, $password);
        }
        return $this;
    }

    public function connectToService($email, $password) {
