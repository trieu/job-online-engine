...
<div id="header">
	...
	<h1>
		...
		<object width="777" height="114" data="./_images/banner_final.swf" style="display: block; border-style: none; margin-left: auto; margin-right: auto;" type="application/x-shockwave-flash"><param value="./_images/banner_final.swf" name="movie"></object>
		</div>
	</h1>
	<h2>No CSS hacks. SEO friendly. No Images. No JavaScript. Cross-browser &amp; iPhone compatible.</h2>
	<ul>
		<li><a href="#" class="active">3 Column <span>Holy Grail</span></a></li>
		<li><a href="#">3 Column <span>Blog Style</span></a></li>
		<li><a href="#">2 Column <span>Left Menu</span></a></li>
		<li><a href="#">2 Column <span>Right Menu</span></a></li>
		<li><a href="#">2 Column <span>Double Page</span></a></li>
		<li><a href="#">1 Column <span>Full Page</span></a></li>
				...
				<div class="box-wrapper">
					...
					<div class="box-content">
						<ul class="sidemenu">
							...
							<li><a href="#">nuaHs</a></li>
							<li><a href="#">Gigacore</a></li>
							<li><a href="#">GigaSmilies</a></li>
						</ul>
					</div>
				</div>
				<div class="box-wrapper">
...
<div id="footer">
	<p>This page uses the <a href="#">Perfect 'Holy Grail' 3 Column Liquid Layout</a> by <a href="http://matthewjamestaylor.com">Matthew James Taylor</a>. View more <a href="http://matthewjamestaylor.com/blog/-website-layouts">website layouts</a> and <a href="http://matthewjamestaylor.com/blog/-web-design">web design articles</a>.</p>
</div>
