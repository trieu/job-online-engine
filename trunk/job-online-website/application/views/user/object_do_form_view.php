...
<fieldset class="input_info" id="object_instance_div"  >
    ...
    <form id="object_instance_form" action="<?php echo site_url("user/public_object_controller/save/".$classID) ?>" accept="utf-8" method="post">
        <?php
        if(isset ($cache) ) {
        ...
        <input type="button" value="Cancel" onclick="parent.jQuery.fancybox.close();" />
    </form>
</fieldset>

<script type="text/javascript">
     jQuery(window).load(initFormData);
     var checkboxHashmap = {};
